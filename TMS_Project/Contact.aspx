<%@ Page Title="" Language="C#" MasterPageFile="~/TMSSite1.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="TMS_Project.Contact" %>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Our Address</h3>
                  <p>Village-Noorpur, District-Fazilka, Punjab</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p>bathlasaksham1@gmail.com<br>bathlasaksham1@hotmail.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Call Us</h3>
                  <p>+91 98 559 14190<br>+91 98 780 75300</p>
                </div>
              </div>
            </div>
...
<%--                <div class="validate"></div>--%>
    ...
    <section class="map mt-2">
      <div class="container-fluid p-0">
       ...
       <iframe src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Bathla%20Farm%20House%20Noorpur+(My%20Business%20Name)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
