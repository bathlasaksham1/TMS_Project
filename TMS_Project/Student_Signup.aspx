<%@ Page Title="" Language="C#" MasterPageFile="~/TMSSite1.Master" AutoEventWireup="true" CodeBehind="Student_Signup.aspx.cs" Inherits="TMS_Project.Student_Signup" %>
...
-moz-box-shadow: 1px 2px 25px 0px rgba(0,0,0,0.75);">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Age Should be Within 3 to 80" ControlToValidate="AgeTextBox" Display="Dynamic" ForeColor="Red" MaximumValue="80" MinimumValue="3" SetFocusOnError="True" Type="Integer"></asp:RangeValidator>
                <br />
